...
COMPILER_FLAGS = ["-I%MKLROOT%\include"]
MATH_LINKER_FLAGS = []
#LINKER_FLAGS = ['-L"%IFORT_COMPILER19%\compiler\lib\intel64"', '-L"%MKLROOT%\lib\intel64"', "-lmkl_intel_lp64_dll", "-lmkl_intel_thread_dll", "-lmkl_core_dll", "-llibiomp5md"]
# LINKER_FLAGS = ['-L"%IFORT_COMPILER19%\compiler\lib\intel64\libiomp5md"', '-L"%MKLROOT%\lib\intel64"', "mkl_intel_lp64_dll.lib", "mkl_intel_thread_dll.lib", "mkl_core_dll.lib", "libiomp5md.dll"]
# LINKER_FLAGS = ['-L"%IFORT_COMPILER19%\compiler\lib\intel64\libiomp5md"', '-L"%MKLROOT%\lib\intel64"', "mkl_intel_lp64_dll.lib", "mkl_intel_thread_dll.lib", "mkl_core_dll.lib", "libiomp5md.dll"]
LINKER_FLAGS = ["mkl_intel_lp64_dll.lib", "mkl_sequential_dll.lib", "mkl_core_dll.lib"]
# LINKER_FLAGS = ['/LIBPATH:"%IFORT_COMPILER19%\compiler\lib\intel64\libiomp5md"', '-L"%MKLROOT%\lib\intel64"', "mkl_intel_lp64_dll.lib", "mkl_intel_thread_dll.lib", "mkl_core_dll.lib", "libiomp5md.dll"]

#f2py -c -m fsolvers fsolvers.f90 --f90flags="-I%MKLROOT%\include" -L"%MKLROOT%\lib\intel64\"  -lmkl_intel_lp64_dll -lmkl_intel_thread_dll -lmkl_core_dll -llibiomp5md
#f2py -c -m fsolvers fsolvers.f90 --f90flags="-I'%MKLROOT%'\include" -lmkl_intel_lp64_dll -lmkl_sequential_dll -lmkl_core_dll
#f2py -c -m fsolvers fsolvers.f90 -L"C:\Program Files (x86)\IntelSWTools\compilers_and_libraries_2019\windows\compiler\lib\intel64_win" -L"%MKLROOT%\lib\intel64" -lmkl_intel_lp64_dll -lmkl_intel_thread_dll -lmkl_core_dll -llibiomp5md
#f2py -c -m fsolvers fsolvers.f90 -L"%IFORT_COMPILER19%\compiler\lib\intel64" -L"%MKLROOT%\lib\intel64" -lmkl_intel_lp64_dll -lmkl_intel_thread_dll -lmkl_core_dll -llibiomp5md
